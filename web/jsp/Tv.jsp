...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <form action="/Bootstrap/tv" method="post">
    		...
    		<%
    		 ...
    		 %>
    		 <tr>
    		 	<td><%=tvlist.get(i).getMid() %></td>
    		 	<td><%=tvlist.get(i).getMname() %></td>
    		 	<%-- <td><%=tvlist.get(i).getSid() %></td> --%>
    		 	<%-- <td><%=tvlist.get(i).getNum() %></td> --%>
    		 	<td><%=tvlist.get(i).getPrice() %></td>
    		 	<td><%=tvlist.get(i).getDescribe() %></td>
    		 	<td>
    		 		<select name=<%=i+1 %>> 
