	...
	<br>
       <table class="table table-striped">
    		...
    		<%
				...
				ClassifyDao phone=new ClassifyDao();
				ArrayList<HomepageBean> phonelist=phone.findSid(1);
    			for(int i=0;i<phonelist.size();i++){
    		 %>
    		 <tr>
    		 	<td><%=phonelist.get(i).getMid() %></td>
    		 	<td><%=phonelist.get(i).getMname() %></td>
    		 	<td><%=phonelist.get(i).getSid() %></td>
    		 	<td><%=phonelist.get(i).getNum() %></td>
    		 	<td><%=phonelist.get(i).getPrice() %></td>
    		 	<td><%=phonelist.get(i).getDescribe() %></td>
